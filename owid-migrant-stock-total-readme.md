...
This data package contains the data that powers the chart ["Total number of international immigrants"](https://ourworldindata.org/grapher/migrant-stock-total?v=1&csvType=full&useColumnShortNames=false) on the Our World in Data website. It was downloaded on April 9, 2026.
